...
mixBlendModes.forEach((mixBlendMode) =>
  mixBlendMode.addEventListener('click', changeMixBlendMode)
);
borderStyles.forEach((borderStyle) =>
  borderStyle.addEventListener('click', changeBorderStyles)
);
